# Credit Card Titan Shield
Fraud Detection model based on anonymized credit card transactions

It is important that credit card companies are able to recognize fraudulent credit card transactions so that customers are not charged for items that they did not purchase.

<img src="https://github.com/bhuvanyu09/Credit-Card-Titan-Shield/blob/main/Credit%20card%20sheild.jpeg" width="400" height="250">
...
```
git clone https://github.com/bhuvanyu09/Credit-Card-Titan-Shield.git 
```
